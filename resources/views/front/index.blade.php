...
@section('content')
    ...
    <section id="Top-Categories" class="max-w-[1200px] mx-auto flex flex-col p-[70px_50px] gap-[30px]">
        ...
        {{-- <div class="group/slider flex flex-nowrap w-max items-center overflow-x-auto">
            <div
                class="flex gap-6 animate-[slideToL_50s_linear_infinite] group-hover/slider:pause-animate pl-6 items-center flex-nowrap">
                @foreach ($categories as $category)
                    <a href="{{ route('front.category', $category->slug) }}"
                        class="category-card flex flex-col items-center p-4 gap-2 ring-1 ring-[#DADEE4] rounded-2xl hover:ring-2 hover:ring-[#FF6129] transition-all duration-300">
                        <div
        ...
        <div class="group/slider flex flex-nowrap w-max items-center">
            <div
                class="flex gap-[30px] animate-[slideToR_50s_linear_infinite] group-hover/slider:pause-animate pl-6 items-center flex-nowrap">
                @foreach ($categories as $category)
                    <a href="{{ route('front.category', $category->slug) }}"
