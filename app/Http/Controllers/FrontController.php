...
class FrontController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('front.index', compact('courses', 'categories', 'faqs', 'allFaqs') + $notificationsData);
    }
    ...
    public function learning(Course $course, $courseVideoId)
    {
        ...
        return view('front.learning', compact('course', 'video', 'courseImage', 'faqs', 'allFaqs', 'reviews') + $notificationsData);
    }
